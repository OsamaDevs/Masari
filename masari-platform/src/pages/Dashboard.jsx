          ...
          <>
            ...
            <section className="grid gap-5 md:grid-cols-2 xl:grid-cols-3">
              {recommendedJobs
                ...
                >
                  <h2 className="font-display text-xl font-bold text-[#f1f6ff]">{job.title}</h2>
                  <p className="mt-2 text-xs font-semibold text-[#9ec8c2]">
                    {t('dashboard.closestMajor')}: {getMajorLabel(job.match?.closestMajor || job.major, isArabic)} • {t('dashboard.matchPercent')}: {job.match?.matchPercent ?? 0}%
                  </p>
                  {job.priority && (
